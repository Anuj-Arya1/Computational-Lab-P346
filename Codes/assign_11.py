...
print("For function f (by method midpoint):    ",o1.midpoint_integral(1,2,(2-1)/289,f))
print("For function g (by method midpoint):    ",o1.midpoint_integral(0,math.pi/2,(math.pi/2)/610,g)) 
...
# For function f (by method midpoint):     0.693146806403525
# For function g (by method midpoint):     0.5707970370864733
